<p align="center">
  <img src="web/public/logo.svg?v=0.9.3-white" width="108" alt="VOZEB logo">
</p>
...
<p align="center">
  ...
  <a href="VERSION"><img src="https://img.shields.io/badge/version-v0.9.3-2563eb?style=flat-square" alt="Version"></a>
...
VOZEB 当前版本为 `v0.9.3`，这是基于原创开源画布项目继续开发的二开版本。感谢原创作者 basketikun 对无限画布、AI 创作工作流、Canvas Agent 和 Codex 插件能力的开源贡献。
...
- AI 图片创作：支持文生图、图生图、参考图编辑、图片反推提示词、图片切图、局部蒙版修改和图片放大；图片工作台支持按生成记录保留结果、同记录追加生成、失败重试、任务轮询续取、结果勾选删除、丢失图片清理、记录标题重命名、图片三层兜底访问和每用户并发生成上限。
- 音频与视频：支持音频节点、视频生成、声音/水印配置，以及图片、视频、音频参考输入；视频工作台支持按用户并发上限同时生成多条记录、保留轮询状态，并支持视频结果三层兜底访问。
