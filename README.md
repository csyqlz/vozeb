<p align="center">
  <img src="web/public/logo.svg?v=0.9.2-white" width="108" alt="VOZEB logo">
</p>
...
<p align="center">
  ...
  <a href="VERSION"><img src="https://img.shields.io/badge/version-v0.9.2-2563eb?style=flat-square" alt="Version"></a>
...
VOZEB 当前版本为 `v0.9.2`，这是基于原创开源画布项目继续开发的二开版本。感谢原创作者 basketikun 对无限画布、AI 创作工作流、Canvas Agent 和 Codex 插件能力的开源贡献。
